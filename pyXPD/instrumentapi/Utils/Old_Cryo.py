...
PhaseIds = (
    "Ramp", "Cool", "Plat", "Hold", "End", "Purge", "Delete phase", "Load program", "Save program", "Soak", "Wait")
Commands = {'restart': 10, 'ramp': 11, 'plat': 12, 'hold': 13, 'cool': 14, 'end': 15, 'purge': 16, 'pause': 17,
            'resume': 18, 'stop': 19, 'turbo': 20}
...
def open_cryo_port(port_name):
    ...
    cryo_port = serial.Serial(port_name, baudrate=9600, bytesize=8, parity='N', stopbits=1, timeout=4.0, xonxoff=0,
                              rtscts=0)
    return cryo_port
